        ...
        <div class="py-20 flex justify-center">
            <form class="w-full max-w-lg">
                ...
                <div class="md:flex md:items-center">
                  <div class="md:w-1/3">
                    <button class="shadow bg-teal-400 hover:bg-white focus:shadow-outline focus:outline-none text-white hover:text-gray-900 font-bold py-2 px-4 rounded" type="button">
                      Send
                    </button>
                  </div>
